        ...
        <div className="container-fluid">
          <div className="title-wrapper text-center">
            ...
            <h2 className="text-black title">
              <span className="theme-color ">Kerwin</span> All Features
            </h2>
          </div>
            ...
            <div className="col-lg-12">
              <div className="purchase-block-inner">
                ...
                <h3
                  ...
                  data-aos-delay="100"
                >
                  Purchase The Kerwin and Build Your Own{" "}
                ...
                <a
                  href="https://themeforest.net/item/Kerwin-react-personal-portfolio-template/33404455"
